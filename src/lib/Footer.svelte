		...
		<div class="p-8 max-w-screen-xl mx-auto">
			<div class="mb-10">
				<article>
					...
					<div
						class="flex justify-between max-w-screen-md text-slate-600 text-xl md:flex-row flex-col"
					>
			...
			<span>
				...
				and
				<a href="https://notion.com/" class="text-blue-500">Notion</a>
			</span>
		</div>
	</section>
</footer>
